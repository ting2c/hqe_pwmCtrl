...
extern uint8_t 	 	bUART0_RecvFIFO[RecvSize];
extern uint8_t  	bUART0_TranFIFO[(RecvSize << 1)];
extern uint32_t   GulNum1;
extern uint8_t 	 	bUART1_RecvFIFO[(RecvSize << 1)];
extern uint8_t  	bUART1_TranFIFO[(RecvSize << 1)];
extern volatile uint8_t bUART0_RecvNew;
extern volatile uint8_t bUART1_RecvNew;
extern uint32_t 		usr_duty;
extern uint32_t 		opt;
extern uint32_t 		quick_fix;
extern uint32_t 		quick_fix1;
extern uint64_t 		_10us_cnt ;
/*_____ D E C L A R A T I O N S ____________________________________________*/
